...
export default function Peruibe(){
    ...
    async function buscaTempo(){
        const response = await Api.get('weather?array_limit=8&fields=only_results,temp,city_name,forecast,condition,max,min,description,date,moon_phase&key=96199229&city_name=Peruibe,SP');
